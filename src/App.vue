<template>
  ...
  <span class="self-center text-3xl text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">TERRIS</span>
</button>
          ...
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <router-link to="/donate"
                class="fadein-bot fadein-3 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0 donate">Donate</router-link>
            </li>
          </ul>
        </div>
      </div>
  ...
  <footer
    ...
    <nav class="flex justify-around py-4 text-xs">
      ...
      <router-link to="/donate" class="text-gray-300 hover:text-white">Donate</router-link>
    </nav>
  </footer>
</template>
