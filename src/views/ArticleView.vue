<template>
    <div class="w-full md:w-3/5 h-48 mx-auto md:mt-5">
            ...
            <div>
                ...
                <div>
                    <div class="relative inline-block">
                        <img :src="image" class="rounded-lg w-full h-auto" alt="Thumbnail">
                    </div>
                </div>
...
export default {
    ...
    methods: {
        async getDetails() {
            ...
            axios.get('https://659a3a9b652b843dea535d7c.mockapi.io/api/banks/' + id)
                .then(response => {
