      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.imgur.com/dIxZ2Yc.gif" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My full name is Nguyen Trong Hoang. I
            have 1-2 year of experience in front-end web development and a little in back-end. I have also created some bots
            on Telegram and possess numerous source codes for Messenger bots (click on Portfolio to view).
            I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that
            has
            aesthetic value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Not actually but I like doing Black hat jobs like cracking, hacking (not actually
            hacking), carding, binning,... I have make many premium subcriptions on many apps, softwares, services,... without losing money.
            I know it's dangerous for me, but as you know, the more dangerous, the more exciting it is.
          </p>
        </div>
