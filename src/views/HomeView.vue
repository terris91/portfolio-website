<template>
  <main class="mt-10 md:mt-1 flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center min-h-[65vh] md:min-h-[80vh]">
    <div class="absolute bottom-0 right-0 mr-1 mb-1 text-white text-opacity-50 text-xs">
      © 2024 Terris. All rights reserved. - elncqmelhhcm.click
    </div>
    <div class="max-w-7xl mx-auto flex flex-col relative">
      <transition-group name="fade" tag="div">
        <div
          ...
          :key="index"
          :style="{ position: 'fixed', bottom: '50px', left: `${200 + 70 * index}px`, margin: '10px' }"
          class="social-icon"
        >
          <a :href="icon.link">
            <img :src="icon.src" style="width: 40px; height: 40px;" class="w-9 rounded-full" :alt="icon.alt" />
          </a>
        </div>
      </transition-group>
    </div>
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Terris</h1>
      <div class="py-2">
        <h1
      ...
      <div class="flex justify-center md:justify-start fadein-right">
        <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async"
          data-nimg="1" class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict"
          src="https://i.imgur.com/dIxZ2Yc.gif">
      </div>
    </main>
  </template>
  ...
  export default {
    ...
    data() {
      return {
        socialIcons: [
          { link: 'https://github.com/terris91', src: 'https://i.imgur.com/HxbbTXH.png', alt: 'github' },
          { link: 'https://www.facebook.com/t.hoang0901', src: 'https://i.imgur.com/O8iOiWo.png', alt: 'facebook' },
          { link: 'https://www.instagram.com/_h.916', src: 'https://i.imgur.com/pfGxPuQ.png', alt: 'instagram' },
          { link: 'https://t.me/imtechgeek', src: 'https://i.imgur.com/OgcWQtm.png', alt: 'telegram' },
        ],
        toRotate: ["Web Developer", "Script Kiddie", "Informatics Student", "Tech Enthusiast"],
        period: 2000,
        txt: '',
        loopNum: 0,
        isDeleting: false,
    ...
    methods: {
      ...
      animateIcons() {
        let icons = document.querySelectorAll('.social-icon');
